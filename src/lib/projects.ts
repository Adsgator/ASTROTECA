...
const DEFAULT_BRIEFING: Briefing = {
  ...
  servico1Titulo: '', servico1Descricao: '',
  servico2Titulo: '', servico2Descricao: '',
  servico3Titulo: '', servico3Descricao: '',
  comoFunciona: '', resultadoEsperado: '', prazoResultado: '',
  passo1Titulo: '', passo1Descricao: '',
  passo2Titulo: '', passo2Descricao: '',
  passo3Titulo: '', passo3Descricao: '',
  precoExibir: false,
  ...
  diferencial1Titulo: '', diferencial1Descricao: '',
  diferencial2Titulo: '', diferencial2Descricao: '',
  diferencial3Titulo: '', diferencial3Descricao: '',
